...
**case2.1**
No case 2.1 foi cobrado um sistema de controle de usuários dentro de um coworking. O sistema possui controle de visitantes em aplicação console, permitindo cadastrar entradas, listar registros, registrar saídas, buscar visitantes por nome, aplicar filtros e ordenar os dados, com validações básicas e tratamento de erros.
