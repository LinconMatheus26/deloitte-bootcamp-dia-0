    ...
    try {
        switch (op) {
            ...
            case "4":
                ...
                // AJUSTE: Usamos ToLower() para a busca não falhar se digitar 'lincon' em vez de 'Lincon'
            ...
            case "6":
                // AJUSTE: Ordenamos e já exibimos para confirmar a ordem
